...
urlpatterns = [
    ...
    path('<int:question_id>/create/answer', answer_views.answer_create, name='answer_create'),
    path('create/', question_views.question_create, name='question_create'),
    path('<int:question_id>/modify/', question_views.question_modify, name='question_modify'),
    path('<int:question_id>/delete/', question_views.question_delete, name='question_delete'),
    path('answer/<int:answer_id>/modify/', answer_views.answer_modify, name='answer_modify'),
